...
loop1:
	...
	//CMP A4, #1 				// Compare A4 (Swapped)  and #1
	//BEQ end_loop			// if A4 (Swapped) == 1 (true), end sorting
...
loop2:
	...
	STRB V6, [A1, V2]		// Stores arr[j+1] into arr[j]
	STRB V7, [A1, V5]
